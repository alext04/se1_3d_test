...
public class UserResource extends BaseResource {
    private static final String ALREADY_EXISTING_USERNAME_ERROR = "AlreadyExistingUsername";
    ...
    public Response register(@FormParam("username") String username,
        ...
        try {
            ...
            if (ALREADY_EXISTING_USERNAME_ERROR.equals(e.getMessage())) {
    ...
    public Response update(@FormParam("password") String password,
        ...
        themeId = ValidationUtil.validateTheme(EnvironmentUtil.isUnitTest() ? null : request.getServletContext(), themeId, "theme", true);
